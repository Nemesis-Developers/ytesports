...
if (!message.guild.me.voice.connection) {
    channel.join().then((connection) => {
        ...
        const paras = new Discord.MessageEmbed().setDescription('** 🎛 Now, move me and I'll drag users to a new voice channel.**').setColor('RANDOM') message.channel.send(paras) client.on("voiceStateUpdate", async (oldmem, newmem) => {
